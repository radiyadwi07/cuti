...
$insert = mysqli_query($koneksi, "INSERT INTO karyawan (id, nik, masuk_kerja, nama, jenkel, email, jabatan, departemen, alamat, no_hp, sisa_cuti, password,status)
                            VALUES('$rand','$nik','$masuk_kerja','$nama','$jenkel','$email','$jabatan','$departemen','$alamat','$no_hp','$sisa_cuti','$password','$status')") or die(mysqli_error());
if($insert){
        ...
        <div class="form-group row">
            <div class="col-md-12">
                <div class="input-group">
                    ...
                    <select id="jenkel" name="status" class="form-control" required>
